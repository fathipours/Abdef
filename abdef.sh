...
IP_LIST_URL="https://raw.githubusercontent.com/fathipours/AbDef/main/abuse-ips.ipv4"
TEMP_FILE="/tmp/abuse-ips-update.ipv4"
FILTERED_FILE="/tmp/abuse-ips-filtered-update.ipv4"
